...
| 10   | After collections complete successfully, use the operational dashboards (`Network Overview`, `Device Inventory`, `Performance and SLA`, `Alerts and Events`, `Asset Navigator`, and `Topology`) to view collected data. |   
