...
Extended Network Device Discovery solution package collects inventory data for network devices. Following network device vendors are supported out of the box.   
...
This pack is designed for inventory collection for Network Devices primarily using SNMP standard MIBs.
...
| 4    | Use `Configure and Manage` -> `Network Discovery Targets` to on board Network Devices. Use `Add Devices` or `Import Devices` by Uploading csv file. For Example:<br><table><tr><th>device_ip</th><th>discovery_scope</th></tr><tr><td>10.95.158.10</td><td>yes</td></tr></table> |  
